  ...
  <div class="container">
    ...
    <div class="dropdown mt-2">
      ...
      <ul class="dropdown-menu">
        ...
        <li ><a class="dropdown-item focus-ring" href="page/settings/index.php?userID=<?=$_SESSION['userID'];?>"><small><?=htmlspecialchars($_SESSION['fname']); ?> <?=htmlspecialchars($_SESSION['lname']); ?></small></a></li>
        <li><hr class="dropdown-divider" /></li>
    ...
    <nav class="navbar bg-body-tertiary">
      <div class="container">
        <ul class="nav nav-tabs" id="myTab" role="tablist">
          ...
          <li class="nav-item" role="presentation">
            <form method="post">
              <a class="nav-link" style="color: black; text-decoration: none;" href="page/admin/index.php?$_GET">
