  ...
  <div class="container">
    ...
    <div class="dropdown mt-2">
      ...
      <ul class="dropdown-menu">
        ...
        <li ><a class="dropdown-item" href="page/settings/index.php?userID=<?=$_SESSION['userID'];?>"><small><?=htmlspecialchars($_SESSION['fname']); ?> <?=htmlspecialchars($_SESSION['lname']); ?></small></a></li>
        <li><hr class="dropdown-divider" /></li>
