  ...
  <div class="container">
    ...
    <div class="dropdown mt-2">
      ...
      <ul class="dropdown-menu">
        ...
        <li ><a class="dropdown-item focus-ring" href="page/profile/index.php?userID=<?=$_SESSION['userID'];?>"><small><?=htmlspecialchars($_SESSION['fname']); ?> <?=htmlspecialchars($_SESSION['lname']); ?></small></a></li>
        <li><hr class="dropdown-divider" /></li>
