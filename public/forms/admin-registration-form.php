          ...
          <div class="card-body shadow">
            ...
            <form class="" action="" method="POST">
              ...
              <div class="form-group mb-1" align="center">
                <small><p>
                  By creating an account, you agree to our <a class="text-decoration-none" href="<?php echo url_for('/page/privacy-policy.php'); ?>" target=”_blank”>Privacy Policy</a> and <a class="text-decoration-none" href="<?php echo url_for('/pages/terms.php'); ?>" target=”_blank”>Terms of Use</a>.
                </p></small>
