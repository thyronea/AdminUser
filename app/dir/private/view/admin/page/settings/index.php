          ...
          <div class="py-5">
            ...
            <div class="d-flex align-items-start">
              ...
              <div class="nav flex-column me-3" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                <button class="nav-link active focus-ring py-1 px-2 btn btn-sm border rounded-0" data-bs-toggle="pill" data-bs-target="#profile" type="button" role="tab" aria-selected="true">
                  <small>Profile</small>
                </button>
                <button class="nav-link focus-ring py-1 px-2 btn btn-sm border rounded-0" data-bs-toggle="pill" data-bs-target="#password" type="button" role="tab" aria-selected="false">
                  <small>Password</small>
                </button>
                <a class="nav-link focus-ring py-1 px-2 btn btn-sm border rounded-0" href="/private/view/admin/index.php" type="button" ><small>Back</small></a>
              </div>
