        ...
        <div class="card">
         <div class="card-body shadow" align="center">
           <form method="post">
             ...
             <div class="mt-2">
               <small><a class="text-decoration-none" href="../page/sign-in.php">Resend Verification Code</a></small><br>
               <small><a class="text-decoration-none" href="../page/forgot-pw.php">Reset Password</a></small>
             </div>
           </form>
         </div>
        </div>
