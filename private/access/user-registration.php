...
session_start();
include('dbcon.php');
include '../../vendors/mailer/PHPMailer/src/Exception.php';
include '../../vendors/mailer/PHPMailer/src/PHPMailer.php';
include '../../vendors/mailer/PHPMailer/src/SMTP.php';
...
if(isset($_POST['register_user'])) {
  ...
  http://localhost:8000/private/security/admin-email-verification.php?token=$token
  ...
  if(mysqli_num_rows($check_admin_run) > 0) {
    $_SESSION['warning'] = "This Account Already Exist!";
    ...
    $link = mysqli_real_escape_string($con, "page/user/index.php"); // Link to user's profile
