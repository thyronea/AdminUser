    ...
    <form class="" action="process.php" method="post">
      <div class="row mt-2 g-2">
        ...
        <div class="col" align="center">
                ...
                foreach($result as $pic){
                  ?>
                    <a href="../../image/<?=$pic['filename'];?>" target="_blank">
                      <img src="../../image/<?php echo $pic['filename'];?>" style="width:100%;height:100%;object-fit:cover;">
                    </a>
                  <?php
                }
              }
          ...
          <a type="button" class="mb-3" data-bs-toggle="modal" data-bs-target="#add_user_image" style="color:black;"><i class="bi bi-camera"></i></a>
        </div>
        <!-- user profile -->
        <div class="col">
          <!-- Patient's Name --->
