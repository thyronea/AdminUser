      ...
      <tbody>
        ...
        <?php
            ...
            if(isset($_GET['search']))
            {
              ...
              {
                ?><h5 class="mb-3"><?= $searchnum ?> Results Found For "<?= $filtervalues?>"</h5><hr><?php
                foreach ($query_run as $result)
                {
                  ?>
                  <tr>
                    <td>
                      <a type="button" href="<?= htmlspecialchars($result['link']); ?>" class="text-decoration-none" style="color: black">
                      ...
                      <?php include('pages/admin/modal/send-email.php'); ?>
                    </td>
                  </tr>
                  <?php
                }
