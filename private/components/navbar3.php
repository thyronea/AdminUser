<nav class="navbar navbar-expand-lg bg-body-tertiary" id="navbar">
  <div class="container">
    ...
    <a class="nav-item" href="#scrollspy1">Scrollspy 1</a>
        ...
        <li class="nav-item dropdown">
          ...
          <div class="dropstart">
            <ul class="dropdown-menu">
              <li><a class="dropdown-item" href="/public/page/sign-in.php"><small>Login</small></a></li>
              <li><a class="dropdown-item" href="/public/page/register.php"><small>Register</small></a></li>
            </ul>
          </div>
        </li>
      </ul>
