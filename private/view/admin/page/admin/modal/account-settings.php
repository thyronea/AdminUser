...
<!-- Modal -->
<div class="modal fade" id="account-settings-Modal" tabindex="-1" aria-labelledby="account-settings-ModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-lg">
    <div class="modal-content">
      <div class="modal-header text-center">
        <h1 class="modal-title w-100 fs-5" id="account-settings-ModalLabel">Account Settings</h1>
