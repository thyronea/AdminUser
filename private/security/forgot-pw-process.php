...
function send_password_reset($userID, $fname, $lname, $email, $new_token)
{
  ...
  http://localhost:8000/public/page/user-reset-pw.php?userID=$userID&token=$new_token
...
if(isset($_POST['forgot_pw']))
{
  ...
  if(mysqli_num_rows($check_email_run) > 0)
  {
    ...
    else
    {
      ...
      header("Location: ../../public/page/forgot-pw.php");
      exit(0);
    }
  }
  else
  {
    ...
    header("Location: ../../public/pages/forgot-pw.php");
    exit(0);
  }
}
